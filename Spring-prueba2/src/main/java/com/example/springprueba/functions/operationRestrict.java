...
public abstract class operationRestrict {
    ...
    public List<itemProducto> kardexByOnlyName(List<itemProducto> itemProductosP, String nombre) {
        List<itemProducto> returnArraylistProduct = new ArrayList<>();
        Double saldo = 0.0;
        for (itemProducto itemProductoF : itemProductosP) {
            Double invinicial = 0.0;
    ...
    public List<itemProducto> restrictProductoIdDates(List<itemProducto> itemProductosP, Date fecha) {
        ...
        for (itemProducto itemProductoF : itemProductosP) {
            ...
            if (idProd == id) {
                ...
                ingresos = 0.0;
                salidas = 0.0;
                if (fecha.after(fechaTransproducto) || fecha.equals(fechaTransproducto)) {
                    invinicial = lessThan320Inicial(operation, itemProductoF, invinicial);
                }else{
                    ingresos = lessThan320SalidasIngresos(operation, itemProductoF, ingresos, salidas, "ingresos");
                    salidas = lessThan320SalidasIngresos(operation, itemProductoF, ingresos, salidas, "salidas");
    ...
    public List<itemProducto> mayorIngresosNombreFecha(List<itemProducto> itemProductoList, String nombre, Date fecha){
    ...
    public List<itemProducto> mayorSalidasNombreFecha(List<itemProducto> itemProductoList, String nombre, Date fecha){
        List<itemProducto> itemProductos = equalNameDateForward(fecha,nombre,itemProductoList);
        List<itemProducto> returnList = new ArrayList<>();
        for (itemProducto itemProductoF: itemProductos){
            Integer ope = itemProductoF.getOpe();
    ...
    public List<itemProducto> mayorSalidasFecha(List<itemProducto> itemProductoList, Date fecha){
        List<itemProducto> fechasItemProduct = itemProductosFechaClienteHaciaDelante(fecha, itemProductoList);
        List<itemProducto> returnList = new ArrayList<>();
        for (itemProducto itemProductoF: fechasItemProduct){
            Integer ope = itemProductoF.getOpe();
    ...
    public List<itemProducto> mayorSalidasNombre(List<itemProducto> itemProductoList, String nombre){
    ...
    public List<itemProducto> equalDate(Date clienteFecha, List<itemProducto> vector){
        List<itemProducto> itemProductoList = new ArrayList<>();
        for(itemProducto itemProductoF: vector){
            Date fechaTransproducto = itemProductoF.getFechaact();
            if (fechasEqual(clienteFecha, fechaTransproducto)) {
                itemProductoList.add(itemProductoF);
            }
        }
        return itemProductoList;
    ...
    public boolean fechasEqual(Date productoFecha, Date fechaBuscar){
        if(productoFecha.equals(fechaBuscar)){
            return true;
        }else{
            return false;
        }
    ...
    public List<itemProducto> ivaFechas(Date fecha, List<itemProducto> itemProductosAll) {
        List<itemProducto> returnArraylistProduct = new ArrayList<>();
        Double invinicial = 0.0;
        Double salidas = 0.0;
        Double ingresos = 0.0;
        Integer contador = 0;
        for (itemProducto itemProductoF : itemProductosAll) {
            Integer operation = itemProductoF.getTransproducto().getOper();
            Date fechaTransproducto = itemProductoF.getTransproducto().getFecha();
            if (fecha.after(fechaTransproducto) || fecha.equals(fechaTransproducto)) {
                invinicial = lessThan320Inicial(operation, itemProductoF, invinicial);
            ...
            returnArraylistProduct = saveValuesIva(itemProductosAll.get(contador-1), ingresos, invinicial, returnArraylistProduct);
            invinicial = 0.0;
            ingresos = 0.0;
            if (fecha.after(fechaTransproducto) || fecha.equals(fechaTransproducto)) {
                invinicial = lessThan320Inicial(operation, itemProductoF, invinicial);
        ...
        itemProducto lastItemProduct = itemProductosAll.get(contador-1);
        lastItemProduct.setInvinicial(invinicial);
    ...
    public List<itemProducto> saveValuesIva(itemProducto itemProducto, Double ingresos, Double invinicial, List<itemProducto> agregarList) {
        Double costoIva = itemProducto.getCosto()*0.13;
        itemProducto.setIngresos(ingresos);
        itemProducto.setIva(costoIva);
        itemProducto.setCostoTotal(itemProducto.getCosto()*0.87);
        itemProducto.setInvinicial(invinicial);
        agregarList.add(itemProducto);
        return agregarList;
    }
